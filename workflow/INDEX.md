...
|---|---|---|---|---|---|---|
| INTENT | L2 | draft | 2026-09-25 | pipeline | 编排运行时扶正：kit 自有通用运行时 + 自定义步骤扩展 | ☑0/4 |
| PLAN | L2 | draft | 2026-09-25 | pipeline | 编排运行时扶正 + 自定义步骤扩展 | — |
| SPEC | L2 | draft | 2026-09-25 | pipeline | 编排运行时扶正：kit 自有通用运行时 + 自定义步骤扩展 | — |
