...
| INTENT | L1 | approved | 2026-09-25 | pipeline | gate-checklist 显式配对登记表（关键词匹配退役 + 三处实锤修复） | ☑0/7 |
| PLAN | L1 | approved | 2026-09-25 | pipeline | gate-checklist 显式配对登记表 | — |
...
终态构成：done 53 · closed 6 · fixed 3；查档案用 `node .agents/scripts/kb-search.mjs "<词>" --status all`。
