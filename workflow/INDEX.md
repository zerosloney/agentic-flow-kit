...
|---|---|---|---|---|---|---|
| INTENT | L2 | draft | 2026-09-25 | pipeline | workflow 编排脚本宿主读取形态（kit 交付可被宿主运行时执行的编排脚本） | ☑0/4 |
| PLAN | L2 | draft | 2026-09-25 | pipeline | workflow 编排脚本宿主读取形态 | — |
| SPEC | L2 | draft | 2026-09-25 | pipeline | workflow 编排脚本宿主读取形态 | — |
