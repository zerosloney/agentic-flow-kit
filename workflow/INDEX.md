...
|---|---|---|---|---|---|---|
| PLAN | L1 | approved | 2026-09-25 | pipeline | wf-run 独立复核缺陷修复（P0 prompt 截断 + P1 批） | — |
...
终态构成：done 26 · fixed 4 · closed 3；查档案用 `node .agents/scripts/kb-search.mjs "<词>" --status all`。
