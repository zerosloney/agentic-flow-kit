...
| PLAN | L1 | approved | 2026-09-24 | pipeline | gen-workflow-metrics 预算表 glob 词表收口：单星前缀+后缀匹配，出表警告跳过 | — |
...
终态构成：done 4 · fixed 3 · closed 1；查档案用 `node .agents/scripts/kb-search.mjs "<词>" --status all`。
