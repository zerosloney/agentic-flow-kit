...
| PLAN | L1 | approved | 2026-09-24 | pipeline | 审查 P4 备忘清账：正则收窄、豁免面收紧、钩子匹配加固、fail-closed 补口 | — |
...
终态构成：done 3 · fixed 2 · closed 1；查档案用 `node .agents/scripts/kb-search.mjs "<词>" --status all`。
