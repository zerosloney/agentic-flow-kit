...
| INTENT | L1 | draft | 2026-09-25 | pipeline | 装户面双源漂移修复（fix-double-source-drift） | ☑0/8 |
| PLAN | L1 | approved | 2026-09-25 | pipeline | 装户面双源漂移修复 | — |
...
终态构成：done 43 · closed 6 · fixed 3；查档案用 `node .agents/scripts/kb-search.mjs "<词>" --status all`。
